...
namespace Haxgo.Web.Extensions
{
    public static class SeoExtensions
    {
        ...
        #region Get All UrlRecord

        private static List<UrlRecord> GetUrlRecordList()
        {
            ...
            {
                var UrlBLL = (IRepository<UrlRecord>)DependencyResolver.Current.GetService(typeof(IRepository<UrlRecord>));
            ...
            where T : BaseEntity, ISlugSupported
        {
            ...
            string result = GetUrlRecordList().Where(o => o.EntityId == entity.Id && o.EntityName == entityName).Select(o => o.Slug).FirstOrDefault();
            return result;
        }
        /// <summary>
        /// Get search engine name
        ...
        /// <param name="entity">Entity</param>
        /// <returns>Search engine name</returns>
        public static string GetSeName<T>(Guid EntityId)
            where T : BaseEntity, ISlugSupported
        {
            string entityName = typeof(T).Name;
            string result = GetUrlRecordList().Where(o => o.EntityId == EntityId && o.EntityName == entityName).Select(o => o.Slug).FirstOrDefault();
            return result;
        }
        /// <summary>
             ...
             where T : BaseEntity, ISlugSupported
        {
            ...
            while (true)
            {
                //check whether such slug already exists
                var urlRecord = GetUrlRecordList().Where(o => o.Slug == tempSeName).FirstOrDefault();
        ...
        {
            return GetSeName(name, false, true);
        }
